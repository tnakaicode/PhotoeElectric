...
class Fdtd(Preprocess):
    ...
    def normalinc_p_e(self, jt):
        ...
        for iz in range(1, self.mzz):
            ...
            self.SEx2[iz] = self.SEx1[iz] * self.ce1[imater] \
                ...
                - (self.SHy1[iz] - self.SHy1[iz - 1]) * \
                self.ckez[iz] * self.ce2[imater]
        ...
        for iz in range(1, self.mz1):
            ...
            self.SpsiExz2m[iz] = self.SpsiExz1m[iz] * self.cbze[iz] \
                + (self.SHy1[iz] - self.SHy1[iz - 1]) * self.ccze[iz]

            self.SEx2[iz] = self.SEx2[iz] - \
                self.SpsiExz2m[iz] * self.ce2[self.isdx[iz]]
        ...
        for iz in range(self.mz2 + 1, self.mzz):
            ...
            self.SEx2[iz] = self.SEx2[iz] - \
                self.SpsiExz2p[izz] * self.ce2[self.isdx[iz]]

        # source compensation for E
        self.SEx2[self.izst] = self.SEx2[self.izst] + \
            self.cez2[self.isdx[self.izst]] * SHy00
        self.SEx2[0] = 0.0
        ...
        for iz in range(self.mzz):
            ...
            self.SHy2[iz] = self.SHy1[iz] - \
                (self.SEx2[iz + 1] - self.SEx2[iz]) * self.ckhz1[iz]
        ...
        self.SHy2[self.izst - 1] = self.SHy2[self.izst - 1] + \
            self.ckhz1[self.izst] * SEx00
        ...
        for iz in range(iz1, iz2):
            ...
            self.Ez2[iz, iy1:iy2, ix] = self.Ez2[iz, iy1:iy2, ix] \
                - self.cex2[self.isdz[iz]] * self.SHy2[iz]
        ...
        self.Ex2[iz, iy1:iy2, ix1:ix2] = self.Ex2[iz, iy1:iy2, ix1:ix2] \
            + self.cez2[self.isdx[iz]] * self.SHy2[iz - 1]
        ...
        self.Ex2[iz, iy1:iy2, ix1:ix2] = self.Ex2[iz, iy1:iy2, ix1:ix2] \
            - self.cez2[self.isdx[iz]] * self.SHy2[iz]
        ...
        self.spx2[iz1:iz2] = self.cj1[self.isdx[iz1:iz2]] * self.spx2[iz1:iz2] \
            + self.cj3[self.isdx[iz1:iz2]] * \
            (self.SEx2[iz1:iz2] + self.SEx1[iz1:iz2])
    ...
    def normalinc_p_h(self):
        ...
        for iz in range(iz1, iz2):
            ...
            for ix in range(ix1, ix2):
                ...
                self.Hz2[iz, iy - 1, ix] = self.Hz2[iz, iy - 1, ix] \
                    - self.ckhy1[iy - 1] * self.SEx1[iz]
        ...
        for iz in range(iz1, iz2):
            ...
            for ix in range(ix1, ix2):
                ...
                self.Hz2[iz, iy, ix] = self.Hz2[iz, iy, ix] + \
                    self.ckhy1[iy] * self.SEx1[iz]
        ...
        for iy in range(iy1, iy2):
            ...
            for ix in range(ix1, ix2):
                ...
                self.Hy2[iz - 1, iy, ix] = self.Hy2[iz - 1, iy, ix] \
                    + self.ckhz1[iz - 1] * self.SEx1[iz]
        ...
        for iy in range(iy1, iy2):
            ...
            for ix in range(ix1, ix2):
                ...
                self.Hy2[iz, iy, ix] = self.Hy2[iz, iy, ix] - \
                    self.ckhz1[iz] * self.SEx1[iz]
    ...
    def sweep_isolate_h(self):
        ...
        for iy in range(iy1, iy2):
            ...
            self.Hx2[iz1:iz2, iy, ix1:ix2] = self.Hx1[iz1:iz2, iy, ix1:ix2] \
                - (self.Ez2[iz1:iz2, iy + 1, ix1:ix2] - self.Ez2[iz1:iz2, iy, ix1:ix2]) \
                * self.ckhy1[iy]

        for iz in range(iz1, iz2):

            self.Hx2[iz, iy1:iy2, ix1:ix2] = self.Hx2[iz, iy1:iy2, ix1:ix2] \
                + (self.Ey2[iz + 1, iy1:iy2, ix1:ix2] - self.Ey2[iz, iy1:iy2, ix1:ix2]) \
                * self.ckhz1[iz]
        ...
        for iz in range(iz1, iz2):
            ...
            self.Hy2[iz, iy1:iy2, ix1:ix2] = self.Hy1[iz, iy1:iy2, ix1:ix2] \
                - (self.Ex2[iz + 1, iy1:iy2, ix1:ix2] - self.Ex2[iz, iy1:iy2, ix1:ix2]) \
                * self.ckhz1[iz]

        for ix in range(ix1, ix2):

            self.Hy2[iz1:iz2, iy1:iy2, ix] = self.Hy2[iz1:iz2, iy1:iy2, ix] \
                + (self.Ez2[iz1:iz2, iy1:iy2, ix + 1] - self.Ez2[iz1:iz2, iy1:iy2, ix]) \
                * self.ckhx1[ix]
        ...
        for ix in range(ix1, ix2):
            ...
            self.Hz2[iz1:iz2, iy1:iy2, ix] = self.Hz1[iz1:iz2, iy1:iy2, ix] \
                - (self.Ey2[iz1:iz2, iy1:iy2, ix + 1] - self.Ey2[iz1:iz2, iy1:iy2, ix]) \
                * self.ckhx1[ix]

        for iy in range(iy1, iy2):

            self.Hz2[iz1:iz2, iy, ix1:ix2] = self.Hz2[iz1:iz2, iy, ix1:ix2] \
                + (self.Ex2[iz1:iz2, iy + 1, ix1:ix2] - self.Ex2[iz1:iz2, iy, ix1:ix2]) \
                * self.ckhy1[iy]
    ...
    def sweep_isolate_e(self):
        ...
        for iz in range(iz1, iz2):
            ...
            self.Ey2[iz, iy1:iy2, ix1:ix2] \
                = self.Ey1[iz, iy1:iy2, ix1:ix2] * self.ce1[self.idy[iz, iy1:iy2, ix1:ix2]] \
        ...
        for ix in range(ix1, ix2):
            ...
            self.Ez2[iz1:iz2, iy1:iy2, ix] \
                = self.Ez1[iz1:iz2, iy1:iy2, ix] * self.ce1[self.idz[iz1:iz2, iy1:iy2, ix]] \
    ...
    def sweep_boundary_e(self):
        ...
        for ix in range(1, self.mx1):
            ...
            self.psiEyx2m[iz1:iz2, iy1:iy2, ix] \
                = self.psiEyx1m[iz1:iz2, iy1:iy2, ix] * self.cbxe[ix] \
                + (self.Hz1[iz1:iz2, iy1:iy2, ix] - self.Hz1[iz1:iz2, iy1:iy2, ix - 1]) \
                * self.ccxe[ix]
        ...
        for ix in range(1, self.mx1):
            ...
            self.psiEzx2m[iz1:iz2, iy1:iy2, ix] \
                = self.psiEzx1m[iz1:iz2, iy1:iy2, ix] * self.cbxe[ix] \
                + (self.Hy1[iz1:iz2, iy1:iy2, ix] - self.Hy1[iz1:iz2, iy1:iy2, ix - 1]) \
                * self.ccxe[ix]
        ...
        for ix in range(self.mx2 + 1, self.mxx):
            ...
            self.psiEyx2p[iz1:iz2, iy1:iy2, ixx] \
                = self.psiEyx1p[iz1:iz2, iy1:iy2, ixx] * self.cbxe[ixxr] \
                + (self.Hz1[iz1:iz2, iy1:iy2, ix] - self.Hz1[iz1:iz2, iy1:iy2, ix - 1]) \
                * self.ccxe[ixxr]
        ...
        for ix in range(self.mx2 + 1, self.mxx):
            ...
            self.psiEzx2p[iz1:iz2, iy1:iy2, ixx] \
                = self.psiEzx1p[iz1:iz2, iy1:iy2, ixx] * self.cbxe[ixxr] \
                + (self.Hy1[iz1:iz2, iy1:iy2, ix] - self.Hy1[iz1:iz2, iy1:iy2, ix - 1]) \
                * self.ccxe[ixxr]
        ...
        for iy in range(1, self.my1):
            ...
            self.psiExy2m[iz1:iz2, iy, ix1:ix2] \
                = self.psiExy1m[iz1:iz2, iy, ix1:ix2] * self.cbye[iy] \
                + (self.Hz1[iz1:iz2, iy, ix1:ix2] - self.Hz1[iz1:iz2, iy - 1, ix1:ix2]) \
                * self.ccye[iy]
            self.Ex2[iz1:iz2, iy, ix1:ix2] = self.Ex2[iz1:iz2, iy, ix1:ix2] \
                + self.psiExy2m[iz1:iz2, iy, ix1:ix2] \
                * self.ce2[self.idx[iz1:iz2, iy, ix1:ix2]]
        ...
        for iy in range(1, self.my1):
            ...
            self.psiEzy2m[iz1:iz2, iy, ix1:ix2] \
                = self.psiEzy1m[iz1:iz2, iy, ix1:ix2] * self.cbye[iy] \
                + (self.Hx1[iz1:iz2, iy, ix1:ix2] - self.Hx1[iz1:iz2, iy - 1, ix1:ix2]) \
                * self.ccye[iy]

            self.Ez2[iz1:iz2, iy, ix1:ix2] = self.Ez2[iz1:iz2, iy, ix1:ix2] \
                - self.psiEzy2m[iz1:iz2, iy, ix1:ix2] \
                * self.ce2[self.idz[iz1:iz2, iy, ix1:ix2]]
        ...
        for iy in range(self.my2 + 1, self.myy):
            ...
            self.psiExy2p[iz1:iz2, iyy, ix1:ix2] = \
                self.psiExy1p[iz1:iz2, iyy, ix1:ix2] * self.cbye[iyyr] \
                + (self.Hz1[iz1:iz2, iy, ix1:ix2] - self.Hz1[iz1:iz2, iy - 1, ix1:ix2]) \
                * self.ccye[iyyr]
        ...
        for iy in range(self.my2 + 1, self.myy):
            ...
            self.psiEzy2p[iz1:iz2, iyy, ix1:ix2] \
                = self.psiEzy1p[iz1:iz2, iyy, ix1:ix2] * self.cbye[iyyr] \
                + (self.Hx1[iz1:iz2, iy, ix1:ix2] - self.Hx1[iz1:iz2, iy - 1, ix1:ix2]) \
                * self.ccye[iyyr]
        ...
        for iz in range(1, self.mz1):
            ...
            self.psiExz2m[iz, iy1:iy2, ix1:ix2] \
                = self.psiExz1m[iz, iy1:iy2, ix1:ix2] * self.cbze[iz] \
                + (self.Hy1[iz, iy1:iy2, ix1:ix2] - self.Hy1[iz - 1, iy1:iy2, ix1:ix2]) \
                * self.ccze[iz]

            self.Ex2[iz, iy1:iy2, ix1:ix2] = self.Ex2[iz, iy1:iy2, ix1:ix2] \
                - self.psiExz2m[iz, iy1:iy2, ix1:ix2] \
                * self.ce2[self.idx[iz, iy1:iy2, ix1:ix2]]
        ...
        for iz in range(1, self.mz1):
            ...
            self.psiEyz2m[iz, iy1:iy2, ix1:ix2] \
                = self.psiEyz1m[iz, iy1:iy2, ix1:ix2] * self.cbze[iz] \
                + (self.Hx1[iz, iy1:iy2, ix1:ix2] - self.Hx1[iz - 1, iy1:iy2, ix1:ix2]) \
                * self.ccze[iz]

            self.Ey2[iz, iy1:iy2, ix1:ix2] = self.Ey2[iz, iy1:iy2, ix1:ix2] \
                + self.psiEyz2m[iz, iy1:iy2, ix1:ix2] \
                * self.ce2[self.idy[iz, iy1:iy2, ix1:ix2]]
        ...
        for iz in range(self.mz2 + 1, self.mzz):
            ...
            self.psiExz2p[izz, iy1:iy2, ix1:ix2] \
                = self.psiExz1p[izz, iy1:iy2, ix1:ix2] * self.cbze[izzr] \
                + (self.Hy1[iz, iy1:iy2, ix1:ix2] - self.Hy1[iz - 1, iy1:iy2, ix1:ix2]) \
                * self.ccze[izzr]
        ...
        for iz in range(self.mz2 + 1, self.mzz):
            ...
            self.psiEyz2p[izz, iy1:iy2, ix1:ix2] \
                = self.psiEyz1p[izz, iy1:iy2, ix1:ix2] * self.cbze[izzr] \
                + (self.Hx1[iz, iy1:iy2, ix1:ix2] - self.Hx1[iz - 1, iy1:iy2, ix1:ix2]) \
                * self.ccze[izzr]
    ...
    def develop_pcurrent(self):
        ...
        self.px2[iz1:iz2, iy1:iy2, ix1:ix2] \
            = self.cj1[self.idx[iz1:iz2, iy1:iy2, ix1:ix2]] \
            * self.px2[iz1:iz2, iy1:iy2, ix1:ix2] \
            + self.cj3[self.idx[iz1:iz2, iy1:iy2, ix1:ix2]] \
            * (self.Ex2[iz1:iz2, iy1:iy2, ix1:ix2] + self.Ex1[iz1:iz2, iy1:iy2, ix1:ix2])
        ...
        self.py2[iz1:iz2, iy1:iy2, ix1:ix2] \
            = self.cj1[self.idy[iz1:iz2, iy1:iy2, ix1:ix2]] \
            * self.py2[iz1:iz2, iy1:iy2, ix1:ix2] \
            + self.cj3[self.idy[iz1:iz2, iy1:iy2, ix1:ix2]] \
            * (self.Ey2[iz1:iz2, iy1:iy2, ix1:ix2] + self.Ey1[iz1:iz2, iy1:iy2, ix1:ix2])
        ...
        self.pz2[iz1:iz2, iy1:iy2, ix1:ix2] \
            = self.cj1[self.idz[iz1:iz2, iy1:iy2, ix1:ix2]] \
            * self.pz2[iz1:iz2, iy1:iy2, ix1:ix2] \
            + self.cj3[self.idz[iz1:iz2, iy1:iy2, ix1:ix2]] \
            * (self.Ez2[iz1:iz2, iy1:iy2, ix1:ix2] + self.Ez1[iz1:iz2, iy1:iy2, ix1:ix2])
        ...
        for epsmon in self.iepsmons:
            ...
            if epsmon.pol == 'x':
                ...
                if epsmon.axis == 'x':  # normal to x-axis
                    ...
                    ieps2d = self.idx[:self.mzz + 1,

                                      :self.myy + 1, epsmon.position]

                elif epsmon.axis == 'y':

                    ieps2d = self.idx[:self.mzz + 1,

                                      epsmon.position, :self.mxx]

                else:

                    ieps2d = self.idx[epsmon.position,
                ...
                if epsmon.axis == 'x':
                    ...
                    ieps2d = self.idy[:self.mzz + 1,

                                      :self.myy, sepsmon.position]

                elif epsmon.axis == 'y':

                    ieps2d = self.idy[:self.mzz + 1,

                                      epsmon.position, :self.mxx + 1]

                else:

                    ieps2d = self.idy[epsmon.position,
                ...
                if epsmon.axis == 'x':
                    ...
                    ieps2d = self.idz[epsmon.position,

                                      :self.myy + 1, :self.mxx + 1]
    ...
    def detect_spectra(self):
        ...
        np.savetxt(fname, atime.T, fmt='%.4e', delimiter=' ',
        ...
        edetectft = np.absolute(np.fft.rfft(edetect2, n=self.mfft2)) ** 2
        ...
        thz = np.arange(self.mfft2 // 2 + 1, dtype=np.float64) \
            * 1.0e-12 / (self.dt * self.sampint * self.mfft2)
        ...
        np.savetxt(fname, thz.T, fmt='%.4e', delimiter=' ',
