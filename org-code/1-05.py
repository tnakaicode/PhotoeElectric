...
plot(d2,RpAbs, label="$R_p$",linewidth = 3.0, color='black')     # p-偏光反射率のプロット
xlabel(r"膜厚 (nm)",fontsize=20)   # x 軸のラベル
ylabel("入射角 (deg.)",fontsize=20)  # y 軸のラベル
title("反射率（膜厚依存性）",fontsize=20)          # グラフタイトル
grid(True)                                 # グリッドを表示
axis([0.0,500,0,0.2])                      # プロット範囲
